                ...
                <div class="form-signin">
                    <div  class="card bg-white mb15">
                        ...
                        <div class="card-body p30 rounded-bottom">
                            <form id="signin-form" class="general-form" method="post" accept-charset="utf-8" onSubmit={handleSubmit}>
                                <input type='hidden' name="rise_csrf_token" value="bde860d90acd92894b2c7975d0839a63"/>             
                                    <div class="form-group">
                                        <input type="text" name="email" id="email" class="form-control p10" placeholder="Email" autofocus data-rule-required data-msg-required="This field is required." data-rule-email data-msg-email="Please enter a valid email address."          
                                         value={email}
