                    ...
                    <div class="d-flex w-auto">
                        <ul class="navbar-nav">
                            <li class="nav-item hidden-sm" title="Search (/)">
                                <a  class="nav-link" data-modal-title="Search (/)" data-post-hide-header="1" data-modal-close="1" id="global-search-btn" data-act="ajax-modal" data-title="Search (/)" data-action-url="https://rise.fairsketch.com/search/search_modal_form"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search icon">
                                    <circle cx="11" cy="11" r="8"></circle>
                                    <line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                </a>                     
                            </li>
                            <li class="nav-item dropdown">
                                <a  id="quick-add-icon" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-circle icon"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg></a>
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a  class="dropdown-item clearfix" title="Add task" id="js-quick-add-task" data-act="ajax-modal" data-title="Add task" data-action-url="https://rise.fairsketch.com/tasks/modal_form">Add task</a><a  class="dropdown-item clearfix" title="Add multiple tasks" data-post-add_type="multiple" id="js-quick-add-multiple-task" data-act="ajax-modal" data-title="Add multiple tasks" data-action-url="https://rise.fairsketch.com/tasks/modal_form">Add multiple tasks</a><a  class="dropdown-item clearfix" title="Add project time" id="js-quick-add-project-time" data-act="ajax-modal" data-title="Add project time" data-action-url="https://rise.fairsketch.com/projects/timelog_modal_form">Add project time</a><a  class="dropdown-item clearfix" title="Add event" data-post-client_id="" id="js-quick-add-event" data-act="ajax-modal" data-title="Add event" data-action-url="https://rise.fairsketch.com/events/modal_form">Add event</a><a  class="dropdown-item clearfix" title="Add note" id="js-quick-add-note" data-act="ajax-modal" data-title="Add note" data-action-url="https://rise.fairsketch.com/notes/modal_form">Add note</a><a  class="dropdown-item clearfix" title="Add to do" id="js-quick-add-to-do" data-act="ajax-modal" data-title="Add to do" data-action-url="https://rise.fairsketch.com/todo/modal_form">Add to do</a><a  class="dropdown-item clearfix" title="Add ticket" id="js-quick-add-ticket" data-act="ajax-modal" data-title="Add ticket" data-action-url="https://rise.fairsketch.com/tickets/modal_form">Add ticket</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                <a  id="personal-language-icon" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-globe icon"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg></a>
                                <ul class="dropdown-menu dropdown-menu-end language-dropdown">
                                    <li>
                                        <a  class="dropdown-item clearfix" data-reload-on-success="1" data-act="ajax-request" data-action-url="https://rise.fairsketch.com/team_members/save_personal_language/Spanish">Spanish</a><a  class="dropdown-item clearfix" data-reload-on-success="1" data-act="ajax-request" data-action-url="https://rise.fairsketch.com/team_members/save_personal_language/Norwegian">Norwegian</a><a  class="dropdown-item clearfix" data-reload-on-success="1" data-act="ajax-request" data-action-url="https://rise.fairsketch.com/team_members/save_personal_language/Portuguese">Portuguese</a><a  class="dropdown-item clearfix" data-reload-on-success="1" data-act="ajax-request" data-action-url="https://rise.fairsketch.com/team_members/save_personal_language/German">German</a><a  class="dropdown-item clearfix" data-reload-on-success="1" data-act="ajax-request" data-action-url="https://rise.fairsketch.com/team_members/save_personal_language/Polish">Polish</a><a  class="dropdown-item clearfix" data-reload-on-success="1" data-act="ajax-request" data-action-url="https://rise.fairsketch.com/team_members/save_personal_language/Czech">Czech</a><a  class="dropdown-item clearfix" data-reload-on-success="1" data-act="ajax-request" data-action-url="https://rise.fairsketch.com/team_members/save_personal_language/Italian">Italian</a><a  class="dropdown-item clearfix" data-reload-on-success="1" data-act="ajax-request" data-action-url="https://rise.fairsketch.com/team_members/save_personal_language/Dutch">Dutch</a><a  class="dropdown-item clearfix" data-reload-on-success="1" data-act="ajax-request" data-action-url="https://rise.fairsketch.com/team_members/save_personal_language/French">French</a><a  class="dropdown-item clearfix" data-reload-on-success="1" data-act="ajax-request" data-action-url="https://rise.fairsketch.com/team_members/save_personal_language/Russian">Russian</a><a  class="dropdown-item clearfix" data-reload-on-success="1" data-act="ajax-request" data-action-url="https://rise.fairsketch.com/team_members/save_personal_language/English"><strong>English</strong><span class="float-end checkbox-checked m0"></span></a><a  class="dropdown-item clearfix" data-reload-on-success="1" data-act="ajax-request" data-action-url="https://rise.fairsketch.com/team_members/save_personal_language/Greek">Greek</a>                                </li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                <a  class="nav-link" id="reminder-icon" data-post-reminder_view_type="global" title="Reminders (Private)" data-act="ajax-modal" data-title="Reminders (Private)" data-action-url="https://rise.fairsketch.com/events/reminders"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clock icon"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg> 
                                </a>                       
                            </li>
                            <li class="nav-item dropdown">
                                <a  id="web-notification-icon" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-total="3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell icon"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg> <span class="badge bg-danger up">3</span></a>                        <div class="dropdown-menu dropdown-menu-end notification-dropdown w400">
                            ...
                            <li class="nav-item dropdown">
                                <a id="user-dropdown"  class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="button" aria-expanded="false">
                                    <span class="avatar-xs avatar me-1">
                                        <img alt="..." src="https://rise.fairsketch.com/files/profile_images/_file62ad94f892365-avatar.png"/>
                                    </span>
                                    {nom && prenom ? (

                                    <span class="user-name ml10">Bienvenue, {prenom} {nom}</span>
                                    ) : (
